...
import eu.arrowhead.qos.monitor.event.SLAVerificationParameter;
...
public class FTT_SE implements Monitor {

    public static final Logger LOG = Logger.getLogger(FTT_SE.class.getName());
